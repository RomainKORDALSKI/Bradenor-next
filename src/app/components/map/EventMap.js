  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        // Filtre les événements avec des coordonnées valides
      ...
      <header className="header-map">
        <div className="intro">
          ...
          <div className="textContainer">
            ...
            <p>
              Bonjour et bienvenue sur notre site dédié aux braderies des
              Hauts-de-France ! Ce projet a été créé par un développeur web en
              formation pour faciliter la recherche de braderies dans notre
              région.
            </p>
            <strong>Fonctionnalités pour les visiteurs :</strong>
            <ul>
              <li>
                Recherche de braderies par géolocalisation, par ville ou
            ...
            <p>
              Nous espérons que ce site vous aidera à trouver et organiser les
              meilleures braderies de la région. Bonne recherche !
            </p>
          </div>
        </div>
      </header>
